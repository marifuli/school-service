...
namespace Marifuli\SchoolService\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Marifuli\SchoolService\Repositories\InstallRepository;
use Marifuli\Service\Repositories\InstallRepository as ServiceRepository;
use Marifuli\SchoolService\Requests\UserRequest;
...
class InstallController extends Controller{
    ...
    public function post_user(UserRequest $request){
		...
		return response()->json([
            'message' => __('school::install.done_msg'), 'goto' => route('service.done')
        ]);
    }
}
